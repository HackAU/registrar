...
if(EMAIL_HEADER_IMAGE && EMAIL_HEADER_IMAGE.indexOf("https") == -1){
...
controller.sendVerificationEmail = function(email, token, callback) {
  ...
  var options = {
    to: email,
    subject: "[HackAU] - Verify your email"
  };
...
controller.sendPasswordResetEmail = function(email, token, callback) {
  ...
  var options = {
    to: email,
    subject: "[HackAU] - Password reset requested!"
  };
...
controller.sendPasswordChangedEmail = function(email, callback){
  ...
  var options = {
    to: email,
    subject: "[HackAU] - Your password has been changed!"
  };
